...
import { Save, User, Clock, Coffee, AlertCircle } from "lucide-react";
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <Input type="number" defaultValue="4" className="w-20 font-bold text-center h-10 dark:bg-slate-800 dark:border-slate-700" />
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <Input type="number" defaultValue="15" className="w-20 font-bold text-center h-10 dark:bg-slate-800 dark:border-slate-700" />
            ...
            <Card className="border-none shadow-sm bg-white dark:bg-slate-900 overflow-hidden ring-1 ring-slate-200 dark:ring-slate-800">
                ...
                <CardContent className="p-8 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Input type="number" defaultValue="10" className="w-20 font-bold text-center h-10 dark:bg-slate-800 dark:border-slate-700" />
                            <span className="text-sm font-bold text-slate-400">Min</span>
                        </div>
                    </div>
